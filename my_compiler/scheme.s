...
%define MAKE_LITERAL_FRACTION(first, second) (((((first - start_of_data) << ((WORD_SIZE - TYPE_BITS) >> 1)) | (second - start_of_data)) << TYPE_BITS) | T_FRACTION)
...
%macro PLUS_NUMERATOR 1
	DATA_UPPER %1
	add %1, start_of_data
	mov %1, qword [%1]
%endmacro

%macro PLUST_DENOMINATOR 1
	DATA_LOWER %1
	add %1, start_of_data
	mov %1, qword [%1]
%endmacro
...
%macro SYMBOL_DATA_FROM_STRING 1
mov rax, %1
DATA rax
